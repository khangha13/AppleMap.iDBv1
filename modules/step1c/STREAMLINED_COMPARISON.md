...
> **2025‑12‑05 update:** The legacy helper scripts `fix_vcf_fill_missing.sh` and
> `debug_beagle_vcf.sh` have now been removed from the repository. The notes
> below remain for historical context when comparing the old and streamlined
> templates.
