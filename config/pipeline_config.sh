...
STEP1D_CONSTRAINT="${STEP1D_CONSTRAINT:-epyc4}"
...
STEP1D_PCA_FORCE_CONCAT="${STEP1D_PCA_FORCE_CONCAT:-false}"
STEP1D_PCA_MERGED_EXCLUDE_CHR="${STEP1D_PCA_MERGED_EXCLUDE_CHR:-true}"
STEP1D_CACHE_DIR="${STEP1D_CACHE_DIR:-}"
STEP1D_PACKAGE_DIR="${STEP1D_PACKAGE_DIR:-}"
...
get_step1d_config() {
    ...
    [ -n "${STEP1D_CONSTRAINT:-}" ] && echo "CONSTRAINT=${STEP1D_CONSTRAINT}"
    [ -n "${SLURM_QOS}" ] && echo "QOS=${SLURM_QOS}"
}
